...
$ACCESS_TOKEN = 'UAaZWrcVaIjkEPKA9fTnKRuy2FdmemHx5tkpgtFbHZ0EZZwzq91zC2LtTd+ORlBwZzBoibkjDeEx8z8O8Qa/ai9mYQOARfja/k4UocqIV9zKRBxsMVV7uwT2+AoxtFsGIFWToa9Rsvqg/Ej3L8yXXQdB04t89/1O/w1cDnyilFU='; // Access Token ค่าที่เราสร้างขึ้น
 ...
 foreach ($request_array['events'] as $event)
 {
  ...
  if ( $event['type'] == 'message' ) 
  {
   ...
   if( $event['message']['type'] == 'text' )
   {
	   ...
	   if($text == "วันนี้หวยออกอะไร"||$text == "เลขเด็ด"||$text == "ขอหวย"){
